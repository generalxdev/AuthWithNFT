    ...
    return (
        <footer className="footer p-10 bg-slate-300 text-base-content">
            <div>
                ...
                <div className={styles.footerHover}>BRAND</div>
                <div className={styles.footerHover}>Design</div>
                <div className={styles.footerHover}>Marketing</div>
                <div className={styles.footerHover}>Advertisement</div>
            </div>
            <div>
                <span className="footer-title text-black">Company</span>
                <div className={styles.footerHover}>About us</div>
                <div className={styles.footerHover}>Contact</div>
                <div className={styles.footerHover}>Jobs</div>
                <div className={styles.footerHover}>Press kit</div>
            </div>
            <div>
